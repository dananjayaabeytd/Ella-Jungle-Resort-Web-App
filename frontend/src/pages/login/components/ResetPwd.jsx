    ...
    <div className='relative flex flex-col text-gray-700 bg-black bg-opacity-70 shadow-none rounded-xl bg-clip-border mt-[300px] p-10 mb-20'>
        ...
        <form className='max-w-screen-lg mt-8 mb-2 w-80 sm:w-96'>
          <div class='flex flex-col gap-6 mb-1'>
            <h6 class='block mb-[-12px] font-sans text-base antialiased font-semibold leading-relaxed tracking-normal text-white mt-[-20px]'>
              Your Email
            </h6>
          ...
          <button
            class='mt-5 block w-full select-none rounded-lg bg-green-500 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none'
            type='button'
          >
            Get Link
          </button>
