...
export default function ReservationActivity() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-cover">
      <div className="bg-green-600 bg-opacity-90 flex items-center justify-center w-full max-w-[600px] rounded-xl shadow-lg py-5 px-11 text-xl font-extrabold text-white">
        {specialActivity && (
          <div className="flex flex-col w-full">
            ...
            <button className="bg-white hover:bg-green-300 text-green-600 py-2 px-2 rounded-full w-[160px] mx-auto" >  
              Apply
            </button>
          </div>
        )}
