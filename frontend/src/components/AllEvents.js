    ...
    {user?.isAdmin && (
      ...
      <div className="grid grid-cols-1 gap-16 sm:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1">
        ...
        <div className="flex justify-between">
            ...
            <p className="pr-64 text-xs text-gray-600 ">{event.eventBookingDate? event.eventBookingDate.substr(0, 10) : ""}</p>
            ...
            <p className="pl-64 py-2 text-xs text-gray-600 ">{event.eventBookingTime}</p>
