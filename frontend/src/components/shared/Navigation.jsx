...
function NavList() {
  return (
    <ul className="flex flex-col gap-2 my-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        <a href="#" className="flex items-center font-bold transition-colors hover:text-green-500">
          Pages
        </a>
      </Typography>
...
function MyNavbar() {
  ...
  return (
    <Navbar className="sticky top-0 z-50 px-6 py-3 mx-auto bg-white shadow-md mr-[214px] my-7 ml-[75px]">
