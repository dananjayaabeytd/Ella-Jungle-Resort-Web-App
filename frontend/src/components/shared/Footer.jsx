...
const Footer = () => {
  return (
    <div className="mt-10 w-full bg-black py-16 px-10 grid md:grid-cols-2 gap-8 text-gray-300 bottom-0">
      <div className="">
        <h3 className="text-2xl font-bold text-green-400">Ella Jungle Resort</h3>
        <p className="py-4">
      ...
      <div className="flex md:justify-around justify-start mt-5">
        <div>
